...
# Answer TK ^ What is this?
require 'lib/game'

# put code here ask the user for their name, and save it
# put code here print a welcome message for your user
puts "Welcome to the improved Secret Number Game with Objects. Let's get your name to start out. Enter it here:"
player_name = gets.chomp 
new_player = Person.new player_name
new_player.greet
